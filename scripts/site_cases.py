...
CASES: list[CaseEntry] = [
    ...
    CaseEntry(
        ...
        badge_class="bdg-plan",
        category="solid",
        label_en="BCC - locally advanced - hedgehog inhibitor 1L",
        summary_en="Locally advanced BCC in Gorlin syndrome where resection and radiation are not appropriate, so the plan should route to 1L SMO/Hedgehog inhibition instead of a form-only starter.",
    ),
    ...
    # -- ENGINE-VERIFIED COVERAGE PLANS (promoted from plan-capable starter-only diseases) --
    CaseEntry(
        ...
        summary_en="Engine-verified coverage plan for locally advanced anal SCC; routes to concurrent chemoradiation instead of an auto-stub-only picker entry.",
    ),
    CaseEntry(
        ...
        summary_en="Engine-verified coverage plan for advanced chondrosarcoma with systemic 1L routing.",
    ),
    CaseEntry(
        ...
        summary_en="Engine-verified coverage plan for epithelioid sarcoma routing to tazemetostat.",
    ),
    CaseEntry(
        ...
        summary_en="Engine-verified coverage plan for advanced well-differentiated GI NET routing to lanreotide.",
    ),
    CaseEntry(
        ...
        summary_en="Engine-verified coverage plan for granulosa cell tumor routing to carboplatin/paclitaxel.",
    ),
    CaseEntry(
        ...
        summary_en="Engine-verified coverage plan for inflammatory myofibroblastic tumor routing to crizotinib.",
    ),
    CaseEntry(
        case_id="coverage-lam-sirolimus-1l",
        file="patient_coverage_lam_sirolimus_1l.json",
        label_ua="LAM - sirolimus 1L",
        summary_ua="Engine-verified coverage plan for lymphangioleiomyomatosis routing to sirolimus.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="LAM - sirolimus 1L",
        summary_en="Engine-verified coverage plan for lymphangioleiomyomatosis routing to sirolimus.",
    ),
    CaseEntry(
        ...
        summary_en="Engine-verified coverage plan for advanced systemic mastocytosis routing to midostaurin.",
    ),
    CaseEntry(
        ...
        summary_en="Engine-verified coverage plan for malignant mesothelioma routing to nivolumab/ipilimumab.",
    ),
    CaseEntry(
        case_id="coverage-mpnst-ai-1l",
        file="patient_coverage_mpnst_ai_1l.json",
        label_ua="MPNST - doxorubicin/ifosfamide 1L",
        summary_ua="Engine-verified coverage plan for MPNST routing to doxorubicin/ifosfamide.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="MPNST - doxorubicin/ifosfamide 1L",
        summary_en="Engine-verified coverage plan for MPNST routing to doxorubicin/ifosfamide.",
    ),
    CaseEntry(
        ...
        summary_en="Engine-verified coverage plan for advanced medullary thyroid carcinoma routing to selpercatinib.",
    ),
    CaseEntry(
        case_id="coverage-pcnsl-matrix-1l",
        file="patient_coverage_pcnsl_matrix_1l.json",
        label_ua="PCNSL - MATRIX 1L",
        summary_ua="Engine-verified coverage plan for primary CNS lymphoma routing to MATRIX.",
        badge="Treatment Plan", badge_class="bdg-plan", category="b_aggressive",
        label_en="PCNSL - MATRIX 1L",
        summary_en="Engine-verified coverage plan for primary CNS lymphoma routing to MATRIX.",
    ),
    CaseEntry(
        ...
        summary_en="Engine-verified coverage plan for metastatic pancreatic NET routing to everolimus.",
    ),
    CaseEntry(
        ...
        summary_en="Engine-verified coverage plan for advanced salivary carcinoma routing to paclitaxel/carboplatin.",
    ),
    CaseEntry(
        ...
        summary_en="Engine-verified coverage plan for advanced soft-tissue sarcoma routing to doxorubicin.",
    ),
    CaseEntry(
        ...
        summary_en="Engine-verified coverage plan for metastatic testicular GCT routing to BEP.",
    ),
    CaseEntry(
        ...
        summary_en="Engine-verified coverage plan for TGCT routing to pexidartinib.",
    ),
    CaseEntry(
        ...
        summary_en="Engine-verified coverage plan for anaplastic thyroid carcinoma routing to carboplatin/paclitaxel.",
    ),
    CaseEntry(
        ...
        summary_en="Engine-verified coverage plan for high-risk IDH-mutant low-grade glioma routing to RT plus PCV.",
    ),
    CaseEntry(
        ...
        summary_en="Engine-verified coverage plan for pediatric JMML routing to allogeneic HCT pathway.",
    ),
    CaseEntry(
        ...
        summary_en="Engine-verified coverage plan for treatment-requiring meningioma routing to maximal safe resection plus adjuvant RT review.",
    ),
    ...
    # Additional hereditary suspicion / confirmed-carrier
    CaseEntry(
        case_id="prevention-men1-pedigree",
        file="patient_men1_pedigree_prevention.json",
        label_ua="Підозра на MEN1 · класичні критерії · germline MEN1-панель",
        summary_ua="30-річна жінка, родина відповідає класичним MEN1 критеріям (3 пухлини за 2 покоління). Engine генерує PreventionPlan: стандарт = germline MEN1 panel + multi-organ surveillance (PTH/Ca q1y з 5 років, pituitary MRI q3y, GEP-NET surveillance q1y); альтернатива = empirical multi-organ.",
        badge="Prevention Plan", badge_class="bdg-plan", category="prevention",
        label_en="MEN1 suspicion · classic criteria · germline MEN1 panel",
        summary_en="30yo woman with family meeting classic MEN1 criteria (3 tumors over 2 generations). PreventionPlan: standard = germline MEN1 panel + multi-organ surveillance (PTH/Ca q1y from 5, pituitary MRI q3y, GEP-NET surveillance q1y); alternative = empirical multi-organ.",
    ),
    CaseEntry(
        case_id="prevention-men2-pedigree",
        file="patient_men2_pedigree_prevention.json",
        label_ua="MEN2A (RET C634R) · вирішення про прорпрофілактичну тиреоїдектомію",
        summary_ua="8-річний пацієнт, мати — підтверджений MEN2A (RET C634R) + MTC + двостороння феохромоцитома. PreventionPlan: стандарт = germline RET-панель + прорпрофілактична тиреоїдектомія до 5 років для C634R + calcitonin q6mo; альтернатива = empirical surveillance.",
        badge="Prevention Plan", badge_class="bdg-plan", category="prevention",
        label_en="MEN2A (RET C634R) · prophylactic thyroidectomy timing decision",
        summary_en="8yo with mother confirmed MEN2A (RET C634R) + MTC + bilateral pheo. PreventionPlan: standard = germline RET panel + prophylactic thyroidectomy by age 5 for C634R + calcitonin q6mo; alternative = empirical surveillance.",
    ),
    CaseEntry(
        ...
        summary_en="35yo woman with macrocephaly + mucocutaneous papillomas. PreventionPlan: standard = germline PTEN panel + breast screening from 30 + thyroid US q1y; alternative = empirical surveillance.",
    ),
    CaseEntry(
        case_id="prevention-peutz-jeghers-pedigree",
        file="patient_peutz_jeghers_pedigree_prevention.json",
        label_ua="Peutz-Jeghers · мукокутанеозна пігментація + інвагінація",
        summary_ua="14-річний пацієнт з характерною мукокутанеозною пігментацією + історія small-bowel інвагінації. PreventionPlan: стандарт = germline STK11-панель + small-bowel VCE/MR enterography q2-3y з 8-10 років + колоноскопія q2-3y з 18; альтернатива = empirical surveillance.",
        badge="Prevention Plan", badge_class="bdg-plan", category="prevention",
        label_en="Peutz-Jeghers · mucocutaneous pigmentation + intussusception",
        summary_en="14yo with characteristic mucocutaneous pigmentation + history of small-bowel intussusception. PreventionPlan: standard = germline STK11 panel + small-bowel VCE/MR enterography q2-3y from 8-10 + colonoscopy q2-3y from 18; alternative = empirical surveillance.",
    ),
    CaseEntry(
        case_id="prevention-lynch-carrier",
        file="patient_lynch_confirmed_carrier_prevention.json",
        label_ua="Lynch підтверджений носій (MSH2) · NCCN surveillance",
        summary_ua="29-річна жінка, нещодавно підтверджений MSH2 patogenic variant (cascade testing). PreventionPlan: стандарт = NCCN Genetic/Familial Lynch surveillance (колоноскопія q1-2y з 25; endometrial sampling q1-2y з 30-35); intensified = додатково обговорення risk-reducing hysterectomy/BSO + аспірин per CAPP2.",
        badge="Prevention Plan", badge_class="bdg-plan", category="prevention",
        label_en="Lynch confirmed carrier (MSH2) · NCCN surveillance",
        summary_en="29yo woman, recently confirmed MSH2 pathogenic variant (cascade testing). PreventionPlan: standard = NCCN Lynch surveillance (colonoscopy q1-2y from 25; endometrial sampling q1-2y from 30-35); intensified = adds risk-reducing hysterectomy/BSO + aspirin per CAPP2.",
    ),
    CaseEntry(
        case_id="prevention-brca1-carrier",
        file="patient_brca1_confirmed_carrier_prevention.json",
        label_ua="BRCA1 підтверджений носій (Ashkenazi founder) · breast MRI q1y з 25",
        summary_ua="27-річна жінка, підтверджений BRCA1 c.5266dupC (Ashkenazi founder mutation, cascade testing). PreventionPlan: стандарт = MRI breast q1y з 25 + mammogram з 30 + TVUS + CA 125 q6mo з 30-35; intensified = додатково обговорення RRM 25-30 + RRSO 35-40 post-childbearing.",
        badge="Prevention Plan", badge_class="bdg-plan", category="prevention",
        label_en="BRCA1 confirmed carrier (Ashkenazi founder) · breast MRI q1y from 25",
        summary_en="27yo woman, confirmed BRCA1 c.5266dupC Ashkenazi founder mutation (cascade testing). PreventionPlan: standard = breast MRI q1y from 25 + mammogram from 30 + TVUS + CA 125 q6mo from 30-35; intensified = adds RRM 25-30 + RRSO 35-40 post-childbearing.",
    ),
    CaseEntry(
        case_id="prevention-vhl-carrier",
        file="patient_vhl_confirmed_carrier_prevention.json",
        label_ua="VHL підтверджений носій (Arg167Gln) · VHL Alliance protocol",
        summary_ua="19-річний чоловік, підтверджений VHL Arg167Gln (cascade після батька). PreventionPlan: стандарт = MRI brain+spine q1y з 15-16, MRI abdomen q1-2y, ophthalmology q1y, catecholamines q1y; intensified = додатково обговорення belzutifan + знижені хірургічні пороги.",
        badge="Prevention Plan", badge_class="bdg-plan", category="prevention",
        label_en="VHL confirmed carrier (Arg167Gln) · VHL Alliance protocol",
        summary_en="19yo male, confirmed VHL Arg167Gln (cascade after father). PreventionPlan: standard = MRI brain+spine q1y from 15-16, MRI abdomen q1-2y, ophthalmology q1y, catecholamines q1y; intensified = adds belzutifan discussion + reduced surgical thresholds.",
    ),

    # v0.3 occupational + chronic-condition pilots
    CaseEntry(
        case_id="prevention-occ-asbestos",
        file="patient_occupational_asbestos_prevention.json",
        label_ua="Азбест → mesothelioma / NSCLC · LDCT + smoking cessation",
        summary_ua="62-річний чоловік, 25 років shipyard insulator + поточний курець. PreventionPlan: стандарт = annual LDCT chest з 10-20р post-exposure + smoking cessation + pleural surveillance; альтернатива = routine general-population screening.",
        badge="Prevention Plan", badge_class="bdg-plan", category="prevention",
        label_en="Asbestos → mesothelioma / NSCLC · LDCT + smoking cessation",
        summary_en="62yo male, 25 years shipyard insulator + current smoker. PreventionPlan: standard = annual chest LDCT from 10-20y post-exposure + smoking cessation + pleural surveillance; alternative = routine general-population screening.",
    ),
    CaseEntry(
        case_id="prevention-occ-benzene",
        file="patient_occupational_benzene_prevention.json",
        label_ua="Бензол → AML / MDS · CBC q6-12mo + smear review",
        summary_ua="55-річний чоловік, 18 років petroleum refinery operator. PreventionPlan: стандарт = CBC q6-12mo + peripheral smear review + low-threshold bone marrow eval; альтернатива = symptom-driven.",
        badge="Prevention Plan", badge_class="bdg-plan", category="prevention",
        label_en="Benzene → AML / MDS · CBC q6-12mo + smear review",
        summary_en="55yo male, 18 years petroleum refinery operator. PreventionPlan: standard = CBC q6-12mo + peripheral smear review + low-threshold bone marrow eval; alternative = symptom-driven.",
    ),
    CaseEntry(
        ...
        summary_en="58yo female, residential radon 8.5 pCi/L + former smoker. PreventionPlan: standard = radon mitigation (sub-slab depressurization) + annual LDCT + smoking cessation; alternative = routine cadence.",
    ),
    CaseEntry(
        ...
        summary_en="68yo male, 22 years in pre-regulation dye industry. PreventionPlan: standard = annual urinalysis + urine cytology + low-threshold cystoscopy; alternative = symptom-driven.",
    ),
    CaseEntry(
        ...
        summary_en="54yo male with long-segment Barrett's, non-dysplastic. PreventionPlan: standard = EGD q3-5y per ACG + high-dose PPI; alternative = q5y cadence for non-dysplastic.",
    ),
    CaseEntry(
        ...
        summary_en="44yo female with UC for 22 years, extensive colitis. PreventionPlan: standard = surveillance colonoscopy with random+targeted biopsies q1-2y (chromoendoscopy preferred per AGA); alternative = q3-5y.",
    ),
    CaseEntry(
        case_id="prevention-psc-ibd",
        file="patient_psc_ibd_prevention.json",
        label_ua="PSC + UC (найвищий ризик) · MRI/MRCP q1y + annual колоноскопія",
        summary_ua="39-річний чоловік з PSC + concurrent UC (highest-risk subgroup). PreventionPlan: стандарт = annual MRI/MRCP + CA 19-9 + annual colonoscopy (PSC-IBD); альтернатива = q2-3y MRI/MRCP.",
        badge="Prevention Plan", badge_class="bdg-plan", category="prevention",
        label_en="PSC + UC (highest risk) · MRI/MRCP q1y + annual colonoscopy",
        summary_en="39yo male with PSC + concurrent UC (highest-risk subgroup). PreventionPlan: standard = annual MRI/MRCP + CA 19-9 + annual colonoscopy (PSC-IBD); alternative = q2-3y MRI/MRCP.",
    ),
    CaseEntry(
        ...
        summary_en="51yo female with refractory celiac type 2 + aberrant IEL clonality. PreventionPlan: standard = strict GFD + VCE/MR enterography q1-2y + IEL clonality monitoring + immunosuppression discussion; alternative = GFD alone.",
    ),

    # Wave 3f: lifestyle + chronic + iatrogenic + additional hereditary
    CaseEntry(
        case_id="prevention-lifestyle-tobacco",
        file="patient_lifestyle_tobacco_prevention.json",
        label_ua="Куріння → lung/urothelial/PDAC/AML · 5A counseling + varenicline",
        summary_ua="57-річний чоловік, поточний курець, 30 pack-years. PreventionPlan: стандарт = 5A counseling + pharmacotherapy + USPSTF LDCT eligibility; альтернатива = brief intervention only.",
        badge="Prevention Plan", badge_class="bdg-plan", category="prevention",
        label_en="Tobacco → lung/urothelial/PDAC/AML · 5A counseling + varenicline",
        summary_en="57yo male, current smoker, 30 pack-years. PreventionPlan: standard = 5A counseling + pharmacotherapy + USPSTF LDCT eligibility; alternative = brief intervention only.",
    ),
    CaseEntry(
        case_id="prevention-lifestyle-alcohol",
        file="patient_lifestyle_alcohol_prevention.json",
        label_ua="Алкоголь → HCC/CRC/esoph-SCC/breast · cessation + naltrexone",
        summary_ua="49-річний чоловік, ~25 напоїв/тиждень × 15р. PreventionPlan: стандарт = AUDIT-C + motivational interviewing + naltrexone + FIB-4 + targeted screening; альтернатива = symptom-driven.",
        badge="Prevention Plan", badge_class="bdg-plan", category="prevention",
        label_en="Alcohol → HCC/CRC/esophageal-SCC/breast · cessation + naltrexone",
        summary_en="49yo male, ~25 drinks/week × 15y. PreventionPlan: standard = AUDIT-C + motivational interviewing + naltrexone + FIB-4 + targeted screening; alternative = symptom-driven.",
    ),
    CaseEntry(
        case_id="prevention-lifestyle-obesity",
        file="patient_lifestyle_obesity_prevention.json",
        label_ua="Ожиріння (BMI 37) → 13 cancers · GLP-1 RA + bariatric ref",
        summary_ua="52-річна постменопаузальна жінка, BMI 37. PreventionPlan: стандарт = structured behavioral + semaglutide 2.4mg + bariatric surgery referral + BMI-elevated cancer screening; альтернатива = screening + brief intervention.",
        badge="Prevention Plan", badge_class="bdg-plan", category="prevention",
        label_en="Obesity (BMI 37) → 13 cancer types · GLP-1 RA + bariatric referral",
        summary_en="52yo postmenopausal woman, BMI 37. PreventionPlan: standard = structured behavioral + semaglutide 2.4mg + bariatric surgery referral + BMI-elevated cancer screening; alternative = screening + brief intervention.",
    ),
    CaseEntry(
        case_id="prevention-chronic-pancreatitis",
        file="patient_chronic_pancreatitis_prevention.json",
        label_ua="Спадковий панкреатит (PRSS1) → PDAC · MRI/MRCP + EUS q1-2y",
        summary_ua="55-річний чоловік з підтвердженим hereditary chronic pancreatitis (PRSS1 R122H). PreventionPlan: стандарт = annual MRI/MRCP + EUS з 40 (CAPS protocol) + smoking + alcohol cessation; альтернатива = symptom-driven.",
        badge="Prevention Plan", badge_class="bdg-plan", category="prevention",
        label_en="Hereditary pancreatitis (PRSS1) → PDAC · MRI/MRCP + EUS q1-2y",
        summary_en="55yo male with confirmed hereditary chronic pancreatitis (PRSS1 R122H). PreventionPlan: standard = annual MRI/MRCP + EUS from 40 (CAPS protocol) + smoking + alcohol cessation; alternative = symptom-driven.",
    ),
    CaseEntry(
        ...
        summary_en="33yo woman, mantle field RT for Hodgkin lymphoma at age 18. PreventionPlan: standard = COG-LTFU protocol (breast MRI from 25; mammogram from 30; LDCT eligibility; thyroid US); alternative = general USPSTF cadence.",
    ),
    CaseEntry(
        ...
        summary_en="44yo woman post-kidney-transplant 6y on tacrolimus + mycophenolate. PreventionPlan: standard = annual skin exam + EBV-DNA q3-6mo + cervical Pap + anal cytology + oral cancer awareness; alternative = general USPSTF cadence.",
    ),
    CaseEntry(
        case_id="prevention-bap1-pedigree",
        file="patient_bap1_pedigree_prevention.json",
        label_ua="Підозра на BAP1 · uveal melanoma + mesothelioma + RCC у родині",
        summary_ua="41-річний чоловік: батько uveal melanoma 52 + mesothelioma 60, cousin clear-cell RCC 38. PreventionPlan: стандарт = germline BAP1 panel + annual ophth + skin + abdominal MRI; альтернатива = empirical surveillance.",
        badge="Prevention Plan", badge_class="bdg-plan", category="prevention",
        label_en="BAP1 suspicion · uveal melanoma + mesothelioma + RCC in family",
        summary_en="41yo male: father uveal melanoma 52 + mesothelioma 60, cousin clear-cell RCC 38. PreventionPlan: standard = germline BAP1 panel + annual ophth + skin + abdominal MRI; alternative = empirical surveillance.",
    ),
    CaseEntry(
        ...
        summary_en="62yo nulliparous postmenopausal woman, menopause 56, 8y combined HRT. PreventionPlan: standard = risk stratification + HRT minimization + tamoxifen chemoprevention discussion + screening adherence; alternative = USPSTF screening + brief intervention.",
    ),
    # ── /PREVENTION CASES ──
