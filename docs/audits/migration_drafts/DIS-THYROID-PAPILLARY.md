# Migration draft — Papillary thyroid carcinoma (PTC) (DIS-THYROID-PAPILLARY)
...
## `algo_thyroid_papillary_1l.yaml` ⚠️ **step 1 entirely prose — every patient falls through to default_indication**
