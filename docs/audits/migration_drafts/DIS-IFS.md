# Migration draft — Infantile fibrosarcoma (IFS) (DIS-IFS)
...
## `algo_ifs_1l.yaml` ⚠️ **step 1 entirely prose — every patient falls through to default_indication**

- **`any_of[0]`** (step 1, SOLE_ANY): `condition: "BIO-NTRK-FUSION positive"`
  ...
  - Proposed rewrite (unreviewed): `{finding: "BIO-NTRK-FUSION"}`
  - Candidate finding key(s): `BIO-NTRK-FUSION`
