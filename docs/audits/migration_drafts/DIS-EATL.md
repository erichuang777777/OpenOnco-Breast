# Migration draft — Enteropathy-Associated T-Cell Lymphoma (DIS-EATL)
...
## `algo_eatl_1l.yaml` ⚠️ **step 1 entirely prose — every patient falls through to default_indication**

- **`any_of[0]`** (step 1, SOLE_ANY): `condition: "EATL diagnosis confirmed"`
