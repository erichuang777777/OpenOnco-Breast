# Migration draft — Mantle Cell Lymphoma (DIS-MCL)
...
## `algo_mcl_2l.yaml` ⚠️ **step 1 entirely prose — every patient falls through to default_indication**

- **`all_of[0]`** (step 1, MIXED_ALL): `condition: "1L progression (post-chemo or post-BTKi+R from 1L algo)"`
