# Migration draft — B-Lymphoblastic Leukemia / Lymphoma (DIS-B-ALL)
...
- **`all_of[0]`** (step 3, SOLE_ALL): `condition: "Default 2L MRD+ or low-burden R/R B-ALL — blinatumomab per BLAST"`
