# Migration draft — Burkitt Lymphoma (DIS-BURKITT)
...
## `algo_burkitt_1l.yaml`

- **`all_of[0]`** (step 2, SOLE_ALL): `condition: "Standard / intermediate risk"`
...
- **`all_of[1]`** (step 2, SOLE_ALL): `condition: "ECOG ≤ 3"`
